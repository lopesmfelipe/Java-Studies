...
public class ForEach {
	...
	public static void main(String[] args) {
		...
		/*
		 * Se a variável que recebe valores for de um tipo primitivo, não da para settar
		 * a variável recebendo algum dado do teclado.
		 * 
		...
		/*
		 * Boas práticas no "for each" o nome da variável que vai receber os valores do
		 * array ou lista, ser o nome singular desse array ou lista
		 */
