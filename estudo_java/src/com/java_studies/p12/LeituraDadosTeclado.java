...
public class LeituraDadosTeclado {
	...
	public static void main(String[] args) {
		 ...
		 * scan.nextLine(); // Vai receber todo o valor digitado
		 * System.out.println("Seu nome completo é: " + nomeCompleto);
		 * 
		 * System.out.println("Digite seu primeiro nome"); String primeiroNome =
		 * scan.next(); // Só vai receber o primeiro valor digitado
		 * System.out.println("Seu primeiro nome é: " + primeiroNome);
		 * 
		 * System.out.println("Digite sua idade"); int idade = scan.nextInt();
		 * System.out.println("Sua idade é: " + idade + " anos");
		 * 
		 * System.out.println("Digite sua altura"); double altura = scan.nextDouble();
		 * System.out.println("Sua altura é de: " + altura + "m");
		 */

		System.out.println(
				"Digite seu primeiro nome, idade, quantdidade de filhos, altura e se possui animais de estimação");
